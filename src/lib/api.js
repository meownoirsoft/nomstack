// API helper functions. Auth flows via the httpOnly `session` cookie set by
// /api/login and /api/signup, so no manual token handling is required —
// browsers attach same-origin cookies automatically.
