...
- Put the main ingredient noun FIRST, followed by descriptive details in parentheses
- Keep amounts and units together with the ingredient name
- Format: "amount unit ingredient (descriptors)" or "amount ingredient (descriptors)"
- Examples: 
  * "1/4 cup cider vinegar"
  * "3 Tbsp mustard (coarse-ground, prepared)" 
  * "3 cloves garlic (peeled and minced)"
  * "1 lime (juiced)"
  * "6 chicken breast halves (skinless, boneless)"
- This makes ingredients easier to scan and read
